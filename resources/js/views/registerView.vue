...
<div class="h-screen md:flex">
	<div
		...
		<div>
			<h1 class="text-white font-bold text-4xl font-sans">MyColoc</h1>
			<p class="text-white mt-1">La meilleure platforme pour une meilleure colocation</p>
			<button type="submit" class="block w-28 bg-white text-blue-700 mt-4 py-2 rounded-2xl font-bold mb-2">Read More</button>
		</div>
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form class="bg-white">
			...
			<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
				...
				<input class="pl-2 outline-none border-none" type="text" name="name" id="" placeholder="Full name" v-model="name"/>
      </div>
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
							...
							<button type="button" v-on:click="register" class="block w-full bg-blue-700 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
		</form>
	</div>
</div>
		...
		register(){
			...
			this.email!=''&&this.password!=''){
				...
				$.ajax({
					...
					type: "POST",
					context: this,
					data: {name:this.name,username:this.username,email:this.email,password:this.password},
