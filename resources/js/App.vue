...
<header>
  ...
  <button @click="go">+</button> <br /> <button @click="come">-</button>
  <h2>{{ authStore.valueisAuthenticated }}</h2>
<div class="header z-50 sticky top-0 bg-white shadow-md flex items-center justify-between px-8 py-02">
    ...
    <nav class="nav font-light text-md">
        <ul class="flex items-center">
            ...
            <li class="ml-5 p-2 rounded font-light bg-blue-700 text-white cursor-pointer">
...
<section class="mt-8">
  <h2 class="ml-5 mb-10 text-blue-700 font-semibold text-lg">Récemment ajoutées</h2>
<div id="offers" class="grid grid-cols-3">
